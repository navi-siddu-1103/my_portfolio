    ...
    <SectionWrapper id="projects" title="My Projects" className="bg-background">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
        {PROJECTS.map((project, index) => (
          <Card key={project.title} className="flex flex-col overflow-hidden bg-card shadow-md hover:shadow-xl transition-all duration-300 animate-fade-in-up hover:scale-[1.02]" style={{ animationDelay: `${index * 150}ms` }}>
